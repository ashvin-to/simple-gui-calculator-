...
def get_result():
    ...
    second_num = float(result_label["text"])
    ...
    if operator == '+':
        ...
        if second_num == 0:
            result_label.config(text="Error!")
                ...
                result_label.config(text=(round(first_num / second_num)))
...
result_label.grid(row=0, column=0, columnspan=5, pady=(40, 30), sticky='w')
result_label.config(font=('arial', 28, 'bold'))
